...
public class AreaSearchResultAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public AreaSearchResultAdapter(Context context, ArrayList<MatchArticleModel> listItems){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof RecentBoardAdapter.Board_VH) {
            final MatchArticleModel currentItem = getItem(position);
            final RecentBoardAdapter.Board_VH VHitem = (RecentBoardAdapter.Board_VH)holder;
