...
public class RecentHireBoardFragment extends BaseFragment implements RecentBoardView {
    ...
    private void init(){
        ...
        recentBoardAdapter = new RecentBoardAdapter(getContext(), matchArticleModelArrayList, 3, isMore, new RecentBoardAdapter.RecentBoardAdapterListener() {
            @Override
    ...
    public void setListData(boolean refresh, int articleNo){
        ...
        Call<ArticleModelListResponse> call = apiService.getRecentArticleList(Constants.HIRE_OF_BOARD_TYPE_MATCH, articleNo, limit);
