...
public class RecruitBoardFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_recruit_board, container, false);
    ...
    private void loadUpdateList(){
        ...
        Call<UpdateTimeResponse> call = apiService.getUpdateTimeList(Constants.RECRUIT_OF_BOARD_TYPE_MATCH);
