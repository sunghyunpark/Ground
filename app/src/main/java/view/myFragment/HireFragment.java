...
public class HireFragment extends Fragment {
    ...
    private void loadArticleList(int no){
        ...
        Call<AboutAreaBoardListResponse> call = apiService.getMyArticleList("hire", UserModel.getInstance().getUid(), no);
    ...
    private void loadFavoriteList(int no){
        ...
        Call<AboutAreaBoardListResponse> call = apiService.getMyFavoriteArticleList("hire", UserModel.getInstance().getUid(), no);
        call.enqueue(new Callback<AboutAreaBoardListResponse>() {
            @Override
            public void onResponse(Call<AboutAreaBoardListResponse> call, Response<AboutAreaBoardListResponse> response) {
                AboutAreaBoardListResponse aboutAreaBoardListResponse = response.body();
